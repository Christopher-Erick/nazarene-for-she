...
import { publishedPrivacy } from "@/lib/cms/public-content";
...
export default async function PrivacyPage() {
  const policy = await publishedPrivacy();
  const body = sanitizeHtml(policy.body || "");

  return (
    <>
      <PageIntro kicker="Privacy" title={policy.title || "We collect only what we need to walk with you."}>
        <p>
